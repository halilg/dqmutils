...
def add_TH1_objects(filelist):
    ...
    for i_inputf_path in filelist:
        ...
        for h_key in TH1_keys(i_inptfile, contains_all=ONLY_KEYS):
            ...
            else                     : th1_dict[h_key_dict] =   h0.Clone()
...
#       KILL(log_prx+'invalid path to input .root file [-i]: '+opts.reference)
    ...
    ### input histograms --
    histo_dict_target = add_TH1_objects(filelist=opts.target)
    histo_dict_refern = add_TH1_objects(filelist=opts.refern)
