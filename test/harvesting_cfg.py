...
# with command line options: stepHarvesting --step HARVESTING:hltOfflineDQMClient --harvesting AtRunEnd --filein filelist:inputs.txt --python_filename harvesting_cfg.py --filetype DQM --mc --scenario pp --conditions auto:phase1_2018_realistic --era Run2_2018 --geometry DB:Extended --no_exec -n -1
...
process.hltOfflineDQMClient_step = cms.Path(process.hltOfflineDQMClient)
process.dqmsave_step = cms.Path(process.DQMSaver)

# Schedule definition
process.schedule = cms.Schedule(process.hltOfflineDQMClient_step,process.dqmsave_step)
